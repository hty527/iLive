package com.amazon.kindle.adapter;
...
public class AppFragmentPagerAdapter extends android.support.v4.app.FragmentStatePagerAdapter {
     ...
     * 接收首页传递的标题
     */
    public AppFragmentPagerAdapter(FragmentManager fm, List<Fragment> mFragment, String[] strings) {
        super(fm);
        this.mFragment = mFragment;
        if(null==mTitleList){
